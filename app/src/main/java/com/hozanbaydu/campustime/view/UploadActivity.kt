...
import com.hozanbaydu.campustime.databinding.ActivityUploadBinding
...
class UploadActivity : AppCompatActivity() {
    ...
    private lateinit var permissionLauncher: ActivityResultLauncher<String> // Çünkü READ_EXTERNAL_STORAGE string
